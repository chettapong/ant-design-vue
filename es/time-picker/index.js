...
import enUS from 'ant-design-vue/es/time-picker/locale/en_US';
...
import { checkValidate, stringToMoment, momentToString, TimeOrTimesType } from 'ant-design-vue/es/_util/moment-util';
...
_extends(TimePicker, {
  ...
  methods: {
    ...
    handleChange: function handleChange(value) {
      ...
      this.$emit('change', this.valueFormat ? momentToString(value, this.valueFormat) : value, value && value.format(format) || '', value ? value.isNextDay : false);
    },
