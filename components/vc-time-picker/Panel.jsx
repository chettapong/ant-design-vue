...
import { getComponentFromProp, getListeners } from 'ant-design-vue/lib/_util/props-util';
...
const Panel = {
  ...
  methods: {
    onChange(newValue) {
      if (newValue && newValue.isNextDay == undefined) {
        if (this.sValue) {
          newValue.isNextDay = this.sValue.isNextDay;
        }
      }
