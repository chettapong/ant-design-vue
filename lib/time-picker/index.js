...
var _TimePicker = require('../vc-time-picker/TimePicker');
...
var _en_US = require('ant-design-vue/lib/time-picker/locale/en_US');
...
var _configConsumerProps = require('ant-design-vue/lib/config-provider/configConsumerProps');

var _base = require('ant-design-vue/lib/base');

var _base2 = _interopRequireDefault(_base);

var _momentUtil = require('ant-design-vue/lib/_util/moment-util');
...
(0, _extends3['default'])(TimePicker, {
  name: 'ATimePicker',
  ...
  methods: {
    ...
    handleChange: function handleChange(value) {
      ...
      this.$emit('change', this.valueFormat ? (0, _momentUtil.momentToString)(value, this.valueFormat) : value, value && value.format(format) || '', value ? value.isNextDay : false);
    },
    ...
    renderTimePicker: function renderTimePicker(locale) {
      ...
      return h(_TimePicker2['default'], timeProps);
    }
  },
