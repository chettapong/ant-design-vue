...
var _MonthTable = require('ant-design-vue/lib/vc-calendar/src/month/MonthTable');
...
var MonthPanel = {
  ...
  methods: {
    ...
    displayYear: function displayYear(year) {
      return (0, _moment2['default'])(year, 'YYYY').format('YYYY');
    }
  },
  ...
  render: function render() {
    ...
    var displayYear = this.displayYear;
