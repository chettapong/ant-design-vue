...
var Combobox = {
  ...
  props: {
    ...
    allowNextDay: _vueTypes2['default'].bool
  },
  methods: {
    onItemChange: function onItemChange(type, itemValue, isNextDay) {
    ...
    getHourSelect: function getHourSelect(hour, isNextDay) {
      var _this = this;
      ...
      var prefixCls = this.prefixCls,
          ...
          use12Hours = this.use12Hours,
          allowNextDay = this.allowNextDay;
      ...
      var selectedIndex = isNextDay ? hourOptionsAdj.indexOf(hourAdj) + 24 : hourOptionsAdj.indexOf(hourAdj);
      var options = allowNextDay ? hourOptionsAdj.map(function (option) {
        return (0, _extends3['default'])({}, formatOption(option, disabledOptions), { isNextDay: false });
      }).concat(hourOptionsAdj.map(function (option) {
        return (0, _extends3['default'])({}, formatOption(option, disabledOptions), { isNextDay: true });
      })) : hourOptionsAdj.map(function (option) {
  ...
  render: function render() {
    ...
    return h(
      ...
      [this.getHourSelect(value.hour(), value.isNextDay || false), this.getMinuteSelect(value.minute()), this.getSecondSelect(value.second()), this.getAMPMSelect(value.hour())]
    );
  }
};
